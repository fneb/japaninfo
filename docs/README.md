...
- How to get around via public transport, particularly in Tôkyô.
- Driving in Japan.
...
The draws to me of Japan are:
 ...
 - The pleasant feeling of cities and the beautiful countryside. When I last went to Tôkyô I was surprised at how at home I felt there. I do live in a big city, London, myself so that'll definitely be part of it (though it is still far smaller than Tôkyô), but it felt pretty comfortable to me. And the countryside is beautiful, similarly comfortable for different reasons, and quiet. With most of the population based in cities, the countryside is pretty quiet. I live in a big city but grew up in the countryside, so I feel the appeal of this too.
...
This website is running on [Docsify](https://docsify.js.org/), an open source static website system. It seems pretty cool so far.
